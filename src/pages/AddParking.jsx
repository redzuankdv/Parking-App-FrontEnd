...
export default function AddParking() {
    ...
    const { setParkings, parkings } = useContext(ParkingContext);
    ...
    async function addParking(event) {
        ...
        try {
            const res = await fetch("https://parking-app-backend-byhd.onrender.com/");
    ...
    async function confirmBooking() {
        ...
        try {
            ...
            setParkings([...parkings, result.data]);
            setShowSlots(false);
        ...
        >
            ...
            {showSlots && (
                <div style={{ marginTop: "30px " }}>
                            ...
                            <div
                                ...
                                onClick={() => {
                                    if (slot.status === "available") {
                                        console.log("Setting selected slot to:", slot.id);
                    ...
                    <Button style={{ marginTop: "20px" }} onClick={confirmBooking}>
                        Book
                    </Button>

                    <p style={{ marginTop: "15px", fontWeight: "bold", color: "green" }}>
                        Parking Fee: RM10 per entrance. Please pay at the entrance counter.
                    </p>
                </div>
            )}

            {receipt && (
                <div style={{ marginTop: "30px", backgroundColor: "#d9f7be", padding: "20px", borderRadius: "10px" }}>
                    ...
                    <p><strong>Parking Fee:</strong> RM10 (per entrance)</p>
                    <p><em>Please pay at the entrance counter.</em></p>
                </div>
            )}
        </div>
    );
